 ...
 */
class arte_Typo_Control extends WP_Customize_Control {
    ...
    */
    public function render_content() {
        ...
        $fonts_array = array();
        $default_variants = apply_filters( 'arte_default_font_variants', array( 'regular', 'italic', '700' ) );
        ...
        ?>
          ...
          <label class="label-title">
            <span><?php esc_html_e( 'Font Family', 'arte' ); ?></span>
        ...
        <?php if( isset( $default[1] ) ) : ?>
          ...
          <label class="label-title">
            <span><?php esc_html_e( 'Font Variant', 'arte' ); ?></span>
          ...
          <label class="label-title">
            <span><?php esc_html_e( 'Text Transform', 'arte' ); ?></span>

            <select name="<?php echo esc_attr( $this->id ); ?>[transform]" class="curly_text_transform">
              <option value="normal" <?php selected( 'normal', $value[3] );  ?>><?php esc_html_e( 'Normal', 'arte' ); ?></option>
              <option value="capitalize" <?php selected( 'capitalize', $value[3] );  ?>><?php esc_html_e( 'Capitalize', 'arte' ); ?></option>
              <option value="uppercase" <?php selected( 'uppercase', $value[3] );  ?>><?php esc_html_e( 'Uppercase', 'arte' ); ?></option>
              <option value="smallcaps" <?php selected( 'smallcaps', $value[3] );  ?>><?php esc_html_e( 'Small Caps', 'arte' ); ?></option>
            </select>
        ...
        <label class="label-title">
          <span>
            <?php esc_html_e( 'Letter Spacing', 'arte' ); ?>
